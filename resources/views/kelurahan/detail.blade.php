                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-right">
                            <a href="{{route('kelurahan_ketersediaan_cetak', ['id' => IDCrypt::Encrypt( $kelurahan->id)])}}" class="btn btn-sm btn-primary mt-2 mt-xl-0"> <i class=" mdi mdi-printer "></i> Cetak data Ketersediaan Rambu</a>
                            <a href="{{route('kelurahan_kebutuhan_cetak', ['id' => IDCrypt::Encrypt( $kelurahan->id)])}}" class="btn btn-sm btn-info mt-2 mt-xl-0"> <i class=" mdi mdi-printer "></i> Cetak data kebutuhan Rambu</a>
                        </div>
                        <br>
