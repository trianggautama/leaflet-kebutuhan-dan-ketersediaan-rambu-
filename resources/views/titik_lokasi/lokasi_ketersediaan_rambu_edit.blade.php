                            ...
                            <form class="forms-sample" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="form-group">
                                     ...
                                     <option value="{{$k->id}}"  {{$lokasi_rambu->kelurahan_id == $k->id ? 'selected' : ''}}>{{$k->nama_kelurahan}}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                  <div class="form-group">
                                   <label for="exampleTextarea1">Alamat</label>
                                  <textarea class="form-control" id="exampleTextarea1" name="alamat" rows="4">{{$lokasi_rambu->alamat}}</textarea>
                                  </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">Tahun Pengadaan</label>
                                            <input type="text" class="form-control" name="apbn" value="{{$lokasi_rambu->ketersediaan_rambu->apbn}}">
                                    </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg" id="exampleFormControlSelect1" name="kondisi">
                                      <option value="1" {{$lokasi_rambu->ketersediaan_rambu->kondisi == "1" ? 'selected' : ''}}>Baik</option>
                                      <option value="2" {{$lokasi_rambu->ketersediaan_rambu->kondisi == "2" ? 'selected' : ''}}>Rusak/kubas</option>
                                      <option value="3" {{$lokasi_rambu->ketersediaan_rambu->kondisi == "3" ? 'selected' : ''}}>Hilang</option>
                                    </select>
                                  </div>
                                  <div class="form-group">
