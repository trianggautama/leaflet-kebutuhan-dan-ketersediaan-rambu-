                                ...
                                <div class="form-group">
                                       ...
                                       <div class="form-group">
                                         ...
                                         <select class="form-control form-control-lg" id="exampleFormControlSelect1" name="prioritas">
                                           <option value="biasa"  {{$lokasi_rambu->kebutuhan_rambu->prioritas == 'biasa' ? 'selected' : ''}}>Biasa</option>
                                           <option value="mendesak"  {{$lokasi_rambu->kebutuhan_rambu->prioritas == 'mendesak' ? 'selected' : ''}}>Mendesak</option>
                                         </select>
                                       </div>
                                       <div class="form-group">
