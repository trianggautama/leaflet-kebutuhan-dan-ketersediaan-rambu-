...
<footer class="footer-area section-gap" style="margin:auto;">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="single-footer-widget">
								<h6>About Us</h6>
								<p>
									Dinas Perhubungan Kota Banjarbaru, Jl.Pangeran Sudirman Nomor 3 , Banjarbaru Utara Banjarbaru
								</p>
                                <p>No.Tlp :0511 0865xx</p>
                                <p>Email  : admindishubbjb@gmail.com</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Tri Angga | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								</p>
							</div>
						</div>
