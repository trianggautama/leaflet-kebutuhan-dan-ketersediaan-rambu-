    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 pb-30 header-text text-center">
                ...
                <p>
                    para petugas survey langsung kelapangan untung mengetahui kondisi
                </p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <a href="images/p1.jpg" class="img-gal">
                    <img class="img-fluid single-project" src="images/p1.jpg" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-4">
                <a href="images/p2.jpg" class="img-gal">
                    <img class="img-fluid single-project" src="images/p2.jpg" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6">
                <a href="images/p3.jpg" class="img-gal">
                    <img class="img-fluid single-project" src="images/p3.jpg" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6">
                <a href="images/p4.jpg" class="img-gal">
                    <img class="img-fluid single-project" src="images/p4.jpg" alt="">
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="row feedback-contents justify-content-center align-items-center">
            <div class="col-lg-6 feedback-left2 relative d-flex justify-content-center align-items-center">
                <a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid"
                        src="depan/img/play-btn.png" alt=""></a>
            </div>
