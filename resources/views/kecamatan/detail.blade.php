                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-right">
                            <a href="{{route('kecamatan_kebutuhan_cetak', ['id' => IDCrypt::Encrypt( $kecamatan->id)])}}" class="btn btn-sm btn-primary mt-2 mt-xl-0" > <i class=" mdi mdi-printer "></i> Cetak data kebutuhan Rambu</a>
